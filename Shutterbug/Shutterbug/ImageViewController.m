...
-(void)setImage:(UIImage *)image{
    ...
    [self.imageView sizeToFit];      //Specially creating setter and getter because we want to implement more functions when we set our image like sizToFit here.No synthesize needed because we are not using an instance variable(_Var)
    self.scrollView.contentSize=self.image ? self.image.size : CGSizeZero;
